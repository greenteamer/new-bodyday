...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'blog_page', 'slug')


    def backwards(self, orm):
        # Adding field 'Page.slug'
        db.add_column(u'blog_page', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(populate_from=None, unique_with=(), max_length=50, null=True, blank=True),
                      keep_default=False)

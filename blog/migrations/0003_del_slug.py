...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blog_page', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), null=True, populate_from=None))

    def backwards(self, orm):

        # Changing field 'Page.slug'
        db.alter_column(u'blog_page', 'slug', self.gf('autoslug.fields.AutoSlugField')(default=1, max_length=50, unique_with=(), populate_from=None))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_review', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='Page_thumb/depositphotos_13539496-Massage-therapy.jpg', max_length=100),
                      keep_default=False)


        # Changing field 'Review.review_choice'
        db.alter_column(u'blog_review', 'review_choice', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):
        # Deleting field 'Review.image'
        db.delete_column(u'blog_review', 'image')


        # Changing field 'Review.review_choice'
        db.alter_column(u'blog_review', 'review_choice', self.gf('django.db.models.fields.CharField')(max_length=7))

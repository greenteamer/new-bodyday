...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.testtext'
        db.add_column(u'blog_page', 'testtext',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=155, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.testtext'
        db.delete_column(u'blog_page', 'testtext')
    ...
    models = {
        u'blog.page': {
            ...
            'testtext': ('django.db.models.fields.CharField', [], {'max_length': '155', 'blank': 'True'}),

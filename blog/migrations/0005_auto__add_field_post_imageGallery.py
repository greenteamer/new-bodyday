...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.imageGallery'
        db.add_column(u'blog_post', 'imageGallery',
                      self.gf('django.db.models.fields.files.ImageField')(default='default', max_length=100, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'blog.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'imageGallery': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'keywords': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
